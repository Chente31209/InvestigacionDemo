...
namespace InvoicingLibrary.Certifcate
{
    public class CertificateMoq : ICertificate
    {
        ...
        {
            var pathCer = @"..\\Resources\\CSD_KARLA_FUENTE_NOLASCO_FUNK671228PH6_20190528_174243s.cer";
            var pathKey = @"..\\Resources\\CSD_KARLA_FUENTE_NOLASCO_FUNK671228PH6_20190528_174243.key";
            File.OpenRead(pathCer);

            X509Certificate x509Certificate = new X509Certificate(pathCer);
            CerFile = Convert.ToBase64String(File.ReadAllBytes(pathCer));           
