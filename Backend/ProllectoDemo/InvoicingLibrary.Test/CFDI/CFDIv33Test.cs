...
namespace InvoicingLibrary.Test.CFDI
{
    ...
    public class CFDIv33Test
    {
        ...
        public ISATProvider EcodexPRovider;
        ...
        public void InitializeRepository()
        {
            ...
            configuration = new ConfigurationBuilder()
                ...
                .Build();
            EcodexPRovider = new CFDIProviders.EcodexProvider(configuration);
        }
        ...
        public void CreateCFDITest()
        {
            try
            {
                var cfdiController = new CFDIv33( _MockRepository, EcodexPRovider);
